...
const projects = {
  project1: {
    ...
    description: '이 프로젝트는 오페라의 유령의 차분하고 화려한 무대를 생각하여 블랙과 골드를 바탕으로 리디자인하게되었습니다. '
  },
  project2: {
  ...
  project4: {
    ...
    description: '공연 포스터 디자인으로 해당 밴드가 선보이는 이미지를 중심으로 리디자인하였습니다.'
  },
  project5: {
    title: '라식할인 카드 뉴스 ',
    image: 'img/portfolio/Frame logo1.jpg',
    description: '학생을 타깃으로한 안과내의 라식할인 카드 뉴스입니다 .'
  },
  project6: {
    title: '상품 패키지 디자인',
